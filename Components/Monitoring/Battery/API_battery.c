...
/* ------------------------------------------------------------- --
   defines
-- ------------------------------------------------------------- */
#define BATTERY_MAX_VOLTAGE   18
#define BATTERY_ADC_RANGE     1024

/* ------------------------------------------------------------- --
   variable
-- ------------------------------------------------------------- */
STRUCT_battery_t battery = {0};
...
static void battery_handler(void* parameters)
{
    ...
    while(1)
    {
        ...
        battery.volt_sch = (BATTERY_MAX_VOLTAGE * ((float)HAL_ADC_GetValue(&hadc1) / BATTERY_ADC_RANGE));
